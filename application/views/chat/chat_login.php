				...
				<div class="span6 offset3">
					<div class="window">
						...
						<div class="box left">
							...
							<p class="desc">To better seve you, Please feel out the form and start chat button!</p>
						</div>
						<div class="box right">
							<form action="<?php echo base_url('chat/do_login'); ?>" method="post">
								<div class="input_row">
									<select name="subject" id="subject">
										<option value="sales">Support Team</option>
										<option value="sales" selected="true">Sales Team</option>
										<option value="sales">Technical Team</option>
								...
								<div class="input_row">
									<textarea name="topic" id="topic" cols="30" rows="10" placeholder="Your Initial Question"></textarea>
								</div>
								<div class="input_row text-right">
									<input type="submit" value="Login" id="chat_login">
								</div>
							</form>
						</div>
						<div class="clear"></div>
